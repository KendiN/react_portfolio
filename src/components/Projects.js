        ...
        <div className="projects-box">
            ...
            <div className="projects-layer">
                ...
                <p>
                    ...
                    closest to them.
                    <a href="https://github.com/KendiN/Emergency-Aid-System"><i className="bx bx-link-external"></i></a>
                </p>
            </div>
        </div>
        ...
        <div className="projects-box">
            ...
            <div className="projects-layer">
                ...
                <p>Redesigned the esoma elearning website and improving
                    ...
                    <a href="https://github.com/KendiN/esoma"><i className="bx bx-link-external"></i></a>
                </p>
            </div>
        </div>
